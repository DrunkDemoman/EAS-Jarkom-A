        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="glyphicon glyphicon-tasks"></i> DATA Lokasi Tes</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            <div class="col-sm-12">
              <div class="panel panel-default">
              <div class="panel-heading bg-green"><i class="glyphicon glyphicon-edit"></i> <b>Form Tambah Lokasi</b></div>
                <div class="panel-body">
                  <form class='form-horizontal' role='form' method=POST action='aksi/kelurahan_simpan.php' enctype='multipart/form-data'>
                    ...
                    <div class='form-group'>
                      <label class='col-sm-4 control-label'>Tempat Lokasi Tes :</label>
                      <div class='col-sm-6'>
                        <input type='text' class='form-control' name='b' placeholder='Nama Tempat' required='required'>
                      </div>
                    </div>
                    <div class='form-group'>
