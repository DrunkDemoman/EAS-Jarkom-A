...
<!-- <img style="border:2px solid #fff;position: absolute;margin-left: 50px;margin-top: 65px;width: 50px; height: 50px;" src="../assets/img/qrcode/<?php echo $r["qrcode"];?>"> -->
             <table cellspacing="0em" style="margin-top: -12px; padding-left: 130px; position: relative;font-family: arial;font-size: 12px;transition-property: 500px;width: 400px;height: 100px;">  
             <tr>
                    <td>No Peserta</td>
                    <td>:</td>
